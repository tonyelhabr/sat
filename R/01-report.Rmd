...
tests of which the reader shoold be made aware.
...
While I won't do any kind of rigorous second evaulation here,
...
viz_schools_math_cors_byyear_diffs <-
  ...
  labs(title = str_wrap(
    paste0(
      "Difference in Year-to-Year Correlation of UIL Academic Scores and SAT/ACT Scores",
...
So, my initial inclination (stated in the introduction to my series
of posts on the academic UIL competitions) seems correct--there is no significant relationship between
